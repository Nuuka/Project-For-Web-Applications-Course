<div id="black" onclick="hideLogin()" style="z-index: 2;box-shadow: 20px 20px 10px #888888;visibility: hidden;height:100%;width:100%;position: absolute;background-color:black;top: 0px;right: 0px;opacity: 0.5;">&nbsp;</div>
<div id="popUpBlock" style="z-index: 3;visibility: hidden;left:calc(50% - 175px);position: absolute;">
	    	...
	    	<tr>
    			...
    			<td width="50%">
		            ...
		            <%if(session.getAttribute("loginState") == "1"){ 
						...
						out.println("<div id=\"dropDownList\"><ul><li onclick=\"location.href = 'logout.jsp';\">logout</li></ul></td>");
					}else{
